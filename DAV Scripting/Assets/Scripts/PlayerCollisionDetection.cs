...
public class PlayerCollisionDetection : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log(message: "Our Player Collision Script is active");
    }

    private void OnCollisionEnter(Collision thingWeHit)
    {
        Debug.Log(message:"We hit a thing" + thingWeHit.collider.name);
    ...
    {
        Debug.Log(message: "We are no longer hitting" + thingWeHit.collider.name);
    }
}